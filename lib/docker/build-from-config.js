...
// todo: make this work for non-github repos

module.exports = async function buildFromConfig(repoConfig) {
  ...
  await buildProject(gitHubAccount.accessToken, 1, orgName, repoName, branch, containerUid, dockerfileTemplateName, preSetupSteps, repoConfig.machine.setup, repoConfig.machine.start)
}
